...
## DO OGARNIECIA! 1.
ggplot(Friday_Night_Lights, aes(x= id, y= ocena, color= sezon))+
  geom_point()+
  # 1. scale_x_continuous(name = "ELO", labels = Friday_Night_Lights$dobre)+
  scale_x_discrete(name = "Odcinki")+
...
srednie <- srednie %>%
  mutate(m_liniowy = (wspolczynniki[1] + rodzic*wspolczynniki[2]),
         roznica_srednia_model = sredni_wzrost_dla_grupy - m_liniowy)
