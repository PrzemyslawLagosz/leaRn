...
## n- okresla ilośc wygenerowanych liczb, min max zasieg z jakiego maja byc generowane
...
for (i in 1:liczbaStluczek) {
  ...
  cat("Stłuczka numer :", i, ", a jej koszt to:", koszt, "PLN \n")
...
for (i in 1:999) {
  moneta <- runif(n=1)
  moneta
  wynik = ifelse(moneta>0.5, "Orzel", "Reszka")
  my_list[i] <- wynik
}
