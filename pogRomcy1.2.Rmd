...
#knitr::opts_knit$set(root.dir = rprojroot::find_rstudio_root_file()) ## 1
```
...
## Wczytanie z ściezki, wymagane podwójny backslash albo forwardsash
auta <- read_excel("C:\\Users\\Przemo\\Desktop\\IT\\R\\auta2012mini.xls", sheet = 1)
...
## ODNOŚNIK ##1 na samym początku https://stackoverflow.com/questions/58272375/how-to-fix-error-in-filefile-ifelseappend-a-w-cannot-open-the-conne

write.table(koty_ptaki,
           file = '~/R/leaRn/reminder/koty_ptaki.csv',
           sep = ",",
           dec = ".")
...
sample <- sample(c("TRUE","FALSE"), size = nrow(koty_ptaki), replace = T, prob = c(0.1, 0.9))
sample
...
# Przypisuje pod nazwy wierszy garunki
...
#Wybierz z ramki danych koty_ptaki wszystkie wiersze poza "Sokołami" (wiersz 8 i 9).
